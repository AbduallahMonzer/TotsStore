...
export default function ProductDetail() {
  ...
  // This triggers the OpnForm widget. If it's not ready, open the form in a new tab.
  function handleOrderClick() {
    if (window.OpnForm) {
      // Set hidden fields before opening
      window.OpnForm.setFields({
        "PRODUCT NAME": product.name,
        "Product Price": product.price,
        Color: product.color,
        // add any field names you used in OpnForm
      });
      setTimeout(() => window.OpnForm.open(), 100);
    } else {
      // fallback: open in new tab, can't prefill in this case
      window.open("https://opnform.com/forms/my-form-lkyjka", "_blank");
    }
  }
